...
<div>React, TypeScript, React-Hook-Form,  Styled-Components, Vercel, Figma, Heroku, Animate.css, Trello, React-Icons, React-Router-Dom, Yup, Axios, React-Toastify e Animate.css.</div>
